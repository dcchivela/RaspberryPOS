...
public:
    ...
    void setupUi(QWidget *pref_printers)
    {
        ...
        kcfg_printZeroTicket = new QCheckBox(pref_printers);
        kcfg_printZeroTicket->setObjectName(QString::fromUtf8("kcfg_printZeroTicket"));

        verticalLayout_2->addWidget(kcfg_printZeroTicket);
    ...
    void retranslateUi(QWidget *pref_printers)
    {
        ...
        kcfg_smallTicketDotMatrix->setText(tr2i18n("Small receipt using a dot-matrix ticket printer (using /dev/lpX)", 0));
        ...
        kcfg_printZeroTicket->setText(tr2i18n("Print tickets with a ZERO total payment.", 0));
