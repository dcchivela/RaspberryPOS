...
public:
    ...
    QCheckBox *kcfg_deleteEmptyCancelledTransactions;
    ...
    void setupUi(QWidget *prefs_db)
    {
        ...
        groupBox_2 = new QGroupBox(prefs_db);
        groupBox_2->setObjectName(QString::fromUtf8("groupBox_2"));
        vboxLayout1 = new QVBoxLayout(groupBox_2);
        vboxLayout1->setObjectName(QString::fromUtf8("vboxLayout1"));
        kcfg_deleteEmptyCancelledTransactions = new QCheckBox(groupBox_2);
        kcfg_deleteEmptyCancelledTransactions->setObjectName(QString::fromUtf8("kcfg_deleteEmptyCancelledTransactions"));

        vboxLayout1->addWidget(kcfg_deleteEmptyCancelledTransactions);
    ...
    void retranslateUi(QWidget *prefs_db)
    {
        ...
        groupBox_2->setTitle(tr2i18n("Extra options", 0));
        kcfg_deleteEmptyCancelledTransactions->setText(tr2i18n("Delete empty cancelled transactions", 0));
    } // retranslateUi
