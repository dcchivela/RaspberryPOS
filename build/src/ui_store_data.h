...
public:
    ...
    void setupUi(QWidget *store_data)
    {
        ...
        sizePolicy1.setHeightForWidth(kcfg_editStoreName->sizePolicy().hasHeightForWidth());
        kcfg_editStoreName->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(kcfg_storeAddress->sizePolicy().hasHeightForWidth());
        kcfg_storeAddress->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(kcfg_storePhone->sizePolicy().hasHeightForWidth());
        kcfg_storePhone->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(kcfg_editTicketMessage->sizePolicy().hasHeightForWidth());
        kcfg_editTicketMessage->setSizePolicy(sizePolicy1);
        ...
        sizePolicy1.setHeightForWidth(kcfg_storeLogo->sizePolicy().hasHeightForWidth());
        kcfg_storeLogo->setSizePolicy(sizePolicy1);
        ...
        label_2->setBuddy(kcfg_storePhone);
        label_3->setBuddy(kcfg_storeAddress);
